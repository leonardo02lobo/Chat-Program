...
public class Panel_Registrarse extends JPanel {
    ...
    private void init() {
        Metodos_Necesarios_Del_Login.iniciarLabel(this, Nombre_Label, (getWidth() / 2) - 150, (getHeight() / 2) - 230, 150, 30, "NAME");
        Metodos_Necesarios_Del_Login.iniciarCajasDeTexto(this, Nombre_Caja, (getWidth() / 2) - 150, (getHeight() / 2) - 200, 300, 30);
        Metodos_Necesarios_Del_Login.iniciarLabel(this, Usuario_Label, (getWidth() / 2) - 150, (getHeight() / 2) - 130, 150, 30, "USERNAME");
        Metodos_Necesarios_Del_Login.iniciarCajasDeTexto(this, Usuario_Caja, (getWidth() / 2) - 150, (getHeight() / 2) - 100, 300, 30);
        Metodos_Necesarios_Del_Login.iniciarLabel(this, Contrasenia_Label, (getWidth() / 2) - 150, (getHeight() / 2) - 30, 150, 30, "PASSWORD");
        ...
        iniciarBoton(Boton, (getWidth() / 2) - 80, getHeight() - 150, 150, 30, "REGISTER");
    }
